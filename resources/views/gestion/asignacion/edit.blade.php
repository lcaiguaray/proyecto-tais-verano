...
@section('contenido')
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-8">
            <h4><i class="mdi mdi-human-handsup"></i> Actualizar</h4>
            <p class="text-gray">Actualizar Asignación</p>
        </div>
    </div>
    <div class="row mt-4">
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2_form form-control form-control-sm {{ $errors->has('empresa') ? ' is-invalid' : '' }}" id="empresa" name="empresa" style="width: 100%;" required>
                                            ...
                                            @foreach($empresas as $empresa)
                                                <option value="{{ $empresa->id }}" {{ (old('empresa', $asignacion->empresa_id) == $empresa->id ? "selected" : "") }}>{{ $empresa->razon_social }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input type="hidden" id="old_usuario" name="old_usuario" value="{{ old('old_usuario', $asignacion->usuario_id) }}">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="descripcion">Descripcion</label>
                                        <textarea class="form-control form-control-sm {{ $errors->has('descripcion') ? ' is-invalid' : '' }}" id="descripcion" name="descripcion" rows="2" required>{{ old('descripcion', $asignacion->descripcion) }}</textarea>
...
@section('js_after')
    ...
    <script>
        ...
        function cargarUsuarios() {
            ...
            let valUsuario = $('#old_usuario').val()
