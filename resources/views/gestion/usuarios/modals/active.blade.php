<div class="modal fade" id="active" tabindex="-1" aria-labelledby="activeLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="activeLabel">Habilitar Usuario</h5>
            ...
            <form id="formActive" action="" method="POST">
                ...
                <div class="modal-body">
                    <p class="text-center">¿Está seguro que desea habilitar el usuario:
