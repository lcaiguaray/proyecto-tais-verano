...
@section('contenido')
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-8">
            <h4><i class="mdi mdi-account-multiple"></i> Actualizar</h4>
            <p class="text-gray">Actualizar Usuario</p>
        </div>
    </div>
    <div class="row mt-4">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm {{ $errors->has('nombre') ? ' is-invalid' : '' }}" id="nombre" name="nombre" value="{{ old('nombre', $usuario->nombre) }}" maxlength="255" required>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm {{ $errors->has('apellido_paterno') ? ' is-invalid' : '' }}" id="apellido_paterno" name="apellido_paterno" value="{{ old('apellido_paterno', $usuario->apellido_paterno) }}" maxlength="255" required>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm {{ $errors->has('apellido_materno') ? ' is-invalid' : '' }}" id="apellido_materno" name="apellido_materno" value="{{ old('apellido_materno', $usuario->apellido_materno) }}" maxlength="255" required>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="fecha-datepicker form-control form-control-sm {{ $errors->has('fecha_nacimiento') ? ' is-invalid' : '' }}" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $usuario->fecha_nacimiento) }}">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm validar_numerico {{ $errors->has('telefono') ? ' is-invalid' : '' }}" id="telefono" name="telefono" value="{{ old('telefono', $usuario->telefono) }}" maxlength="20" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm {{ $errors->has('sexo') ? ' is-invalid' : '' }}" id="sexo" name="sexo" required>
                                            @foreach(sexos() as $sexo)
                                                <option value="{{ $sexo->value }}" {{ (old('sexo', $usuario->sexo) == $sexo->value ? "selected" : "") }}>{{ $sexo->description }}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('sexo'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-sm {{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" name="email" value="{{ old('email', $usuario->email) }}" required>
                                        @if ($errors->has('email'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm {{ $errors->has('direccion') ? ' is-invalid' : '' }}" id="direccion" name="direccion" value="{{ old('direccion', $usuario->direccion) }}">
