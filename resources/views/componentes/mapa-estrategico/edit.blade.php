...
@section('contenido')
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-8">
            <h4><i class="mdi mdi-table-large"></i> Actualizar</h4>
            <p class="text-gray">Actualizar Estratégia</p>
        </div>
    </div>
    <div class="row mt-4">
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2_form form-control form-control-sm {{ $errors->has('mapa_proceso') ? ' is-invalid' : '' }}" id="mapa_proceso" name="mapa_proceso" required>
                                            ...
                                            @foreach($empresa->mapa_proceso->where('activo', true) as $mapa_proceso)
                                                <option value="{{ $mapa_proceso->id }}" {{ (old('mapa_proceso', $estrategia->mapa_proceso_id) == $mapa_proceso->id ? "selected" : "") }}>{{ $mapa_proceso->nombre }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2_form form-control form-control-sm {{ $errors->has('tipo_objeto') ? ' is-invalid' : '' }}" id="tipo_objeto" name="tipo_objeto" style="width: 100%;" required>
                                            ...
                                            @foreach(tipo_objetos() as $item)
                                                <option value="{{ $item->value }}" {{ (old('tipo_objeto', $estrategia->objeto_tipo) == $item->value ? "selected" : "") }}>{{ $item->description }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input type="hidden" id="old_objeto_id" name="old_objeto_id" value="{{ old('old_objeto_id', $estrategia->objeto_id) }}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="nombre">Descripción <span class="text-success">*</span></label>
                                        <input type="text" class="form-control form-control-sm {{ $errors->has('nombre') ? ' is-invalid' : '' }}" id="nombre" name="nombre" value="{{ old('nombre', $estrategia->nombre) }}" maxlength="255" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2_form form-control form-control-sm {{ $errors->has('tipo_estrategia') ? ' is-invalid' : '' }}" id="tipo_estrategia" name="tipo_estrategia" style="width: 100%;" required>
                                            ...
                                            @foreach(tipo_estrategias() as $item)
                                                <option value="{{ $item->value }}" {{ (old('tipo_estrategia', $estrategia->tipo_estrategia) == $item->value ? "selected" : "") }}>{{ $item->description }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group form-check">
                                        <input type="checkbox" class="form-check-input" id="ligado" name="ligado" {{ ($estrategia->ligado) ? ' checked' : '' }}>
