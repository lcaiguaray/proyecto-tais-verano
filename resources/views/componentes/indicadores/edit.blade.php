...
@section('title', '| Actualizar Indicador')
...
@section('contenido')
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-8">
            <h4><i class="mdi mdi-apple-safari"></i> Actualizar</h4>
            <p class="text-gray">Actualizar Indicador</p>
        </div>
    </div>
    <div class="row mt-4">
            ...
            <div class="grid">
                <div class="grid-body">
                    <div class="item-wrapper">
                        ...
                        <form id="formEdit" action="{{ route('indicadores.update', $indicador->id) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="form-row">
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2_form form-control form-control-sm {{ $errors->has('mapa_proceso') ? ' is-invalid' : '' }}" id="mapa_proceso" name="mapa_proceso" required>
                                                    ...
                                                    @foreach($empresa->mapa_proceso->where('activo', true) as $mapa_proceso)
                                                        <option value="{{ $mapa_proceso->id }}" {{ (old('mapa_proceso', $indicador->mapa_proceso_id) == $mapa_proceso->id ? "selected" : "") }}>{{ $mapa_proceso->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2_form form-control form-control-sm {{ $errors->has('tipo_objeto') ? ' is-invalid' : '' }}" id="tipo_objeto" name="tipo_objeto" style="width: 100%;" required>
                                                    ...
                                                    @foreach(tipo_objetos() as $item)
                                                        <option value="{{ $item->value }}" {{ (old('tipo_objeto', $indicador->objeto_tipo) == $item->value ? "selected" : "") }}>{{ $item->description }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                @endif
                                                <input type="hidden" id="old_objeto_id" name="old_objeto_id" value="{{ old('old_objeto_id', $indicador->objeto_id) }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label for="nombre">Nombre <span class="text-success">*</span></label>
                                                <input type="text" class="form-control form-control-sm {{ $errors->has('nombre') ? ' is-invalid' : '' }}" id="nombre" name="nombre" value="{{ old('nombre', $indicador->nombre) }}" maxlength="255" required>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm {{ $errors->has('responsable') ? ' is-invalid' : '' }}" id="responsable" name="responsable" value="{{ old('responsable', $indicador->responsable) }}" maxlength="255" required>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="validar_decimal form-control form-control-sm {{ $errors->has('meta') ? ' is-invalid' : '' }}" id="meta" name="meta" value="{{ old('meta', $indicador->meta) }}" onpaste="return false;" autocomplete="off" maxlength="10" required>
                                                @if ($errors->has('meta'))
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control form-control-sm {{ $errors->has('objetivo') ? ' is-invalid' : '' }}" id="objetivo" name="objetivo" rows="2" required>{{ old('objetivo', $indicador->objetivo) }}</textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control form-control-sm {{ $errors->has('descripcion') ? ' is-invalid' : '' }}" id="descripcion" name="descripcion" rows="2" required>{{ old('descripcion', $indicador->descripcion) }}</textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control form-control-sm {{ $errors->has('realizar') ? ' is-invalid' : '' }}" id="realizar" name="realizar" rows="2" required>{{ old('realizar', $indicador->realizar) }}</textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control form-control-sm {{ $errors->has('mecanismo') ? ' is-invalid' : '' }}" id="mecanismo" name="mecanismo" rows="2" required>{{ old('mecanismo', $indicador->mecanismo) }}</textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control form-control-sm {{ $errors->has('tolerancia') ? ' is-invalid' : '' }}" id="tolerancia" name="tolerancia" rows="2" required>{{ old('tolerancia', $indicador->tolerancia) }}</textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control form-control-sm {{ $errors->has('resultados') ? ' is-invalid' : '' }}" id="resultados" name="resultados" rows="2" required>{{ old('resultados', $indicador->resultados) }}</textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control form-control-sm {{ $errors->has('iniciativa') ? ' is-invalid' : '' }}" id="iniciativa" name="iniciativa" rows="2" required>{{ old('iniciativa', $indicador->iniciativa) }}</textarea>
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2_form form-control form-control-sm {{ $errors->has('formula') ? ' is-invalid' : '' }}" id="formula" name="formula" style="width: 100%;" required>
                                                    ...
                                                    @foreach(tipo_formulas() as $item)
                                                        <option value="{{ $item->value }}" {{ (old('formula', $indicador->formula) == $item->value ? "selected" : "") }}>{{ $item->description }}</option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm {{ $errors->has('formula1_parametro1') ? ' is-invalid' : '' }}" id="formula1_parametro1" name="formula1_parametro1" value="{{ old('formula1_parametro1', $indicador->primer_parametro) }}" maxlength="255">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm {{ $errors->has('formula1_parametro2') ? ' is-invalid' : '' }}" id="formula1_parametro2" name="formula1_parametro2" value="{{ old('formula1_parametro2', $indicador->segundo_parametro) }}" maxlength="255">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm {{ $errors->has('formula2_parametro1') ? ' is-invalid' : '' }}" id="formula2_parametro1" name="formula2_parametro1" value="{{ old('formula2_parametro1', $indicador->primer_parametro) }}" maxlength="255">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm {{ $errors->has('formula2_parametro2') ? ' is-invalid' : '' }}" id="formula2_parametro2" name="formula2_parametro2" value="{{ old('formula2_parametro2', $indicador->segundo_parametro) }}" maxlength="255">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm {{ $errors->has('formula3_parametro1') ? ' is-invalid' : '' }}" id="formula3_parametro1" name="formula3_parametro1" value="{{ old('formula3_parametro1', $indicador->primer_parametro) }}" maxlength="255">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2_form form-control form-control-sm {{ $errors->has('tipo_condicion') ? ' is-invalid' : '' }}" id="tipo_condicion" name="tipo_condicion" style="width: 100%;" required>
                                                    ...
                                                    @foreach(tipo_condiciones_indicador() as $item)
                                                        <option value="{{ $item->value }}" {{ (old('tipo_condicion', $indicador->tipo_condicion) == $item->value ? "selected" : "") }}>{{ $item->description }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="validar_decimal form-control form-control-sm {{ $errors->has('condicion_rojo') ? ' is-invalid' : '' }}" id="condicion_rojo" name="condicion_rojo" value="{{ old('condicion_rojo', $indicador->condicion_rojo) }}" onpaste="return false;" autocomplete="off" maxlength="10" required>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="validar_decimal form-control form-control-sm {{ $errors->has('condicion_verde') ? ' is-invalid' : '' }}" id="condicion_verde" name="condicion_verde" value="{{ old('condicion_verde', $indicador->condicion_verde) }}" onpaste="return false;" autocomplete="off" maxlength="10" required>
