<div class="modal fade" id="modal-delete-fuente" tabindex="-1" aria-labelledby="deleteLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="deleteLabel">Eliminar Data Fuente</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="formDeleteFuente" action="" method="POST">
                @csrf
                @method('put')
                <div class="modal-body">
                    <p class="text-center">¿Está seguro que desea eliminar el data de valor:
